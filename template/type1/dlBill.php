	...
	<div id="contents">
		...
		<form action="/index/billpdf/" method="POST">
			...
			<div class="rightbox">
				...
				<p id="billdate">
					<input type="text" name="year" value="<?= $date['y'] ?>" id="year" style="width:60px;">年　
				...
				<p>
					...
					?>
				<div>
					<input type="text" name="tekikaku" value="<?= $company['10'] ?>" readonly style="width:100%;">
					<style type="text/css">
						input:read-only {
							border: none;
						}
				...
				<table align="right" id="tantohanko">
					...
					<tr>
						...
						?>
						<td id="point">
							<div id="tanto_han" style="display:<?= $disp ?>"><img src="/images/sasaki.gif" width=40></div>
						</td>
					</tr>
				</table>
				<div id="hankochk">
